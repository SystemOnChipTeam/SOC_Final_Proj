...
module controller (
    ...
    output logic MemWriteD,         // memory write enable for store instructions
    output logic JumpD,             // control signal for jump instructions
    output logic BranchD,           // control signals for memory write, jump, and branch instructions
